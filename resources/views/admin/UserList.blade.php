                ...
                <div class="card-body">
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="py-1">
                          <img src="{{ $userList->avatar }}" alt="{{ $userList->name }}">{{ $userList->name }}
                        </td>
                        <td>
                          {{ $userList->email }}
                        </td>
                        ...
                        <td>
                          <a href="/admin/user/{{ $userList->id }}" class="btn btn-gradient-primary btn-sm">编辑</a>
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
